...
export const InstagramFeed: React.FC = () => {
    // Default Mock Data (Fallback) - Upgraded to "Quiet Luxury" Lifestyle
    const mockPosts = [
        { id: '1', handle: '@klyora_official', img: 'https://images.unsplash.com/photo-1511556820780-d912e42b4980?q=80&w=1000', permalink: '#' }, // Abstract Silk/Art
        { id: '2', handle: '@klyora_official', img: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?q=80&w=1000', permalink: '#' }, // Marble/Jewelry Hand
        { id: '3', handle: '@klyora_official', img: 'https://images.unsplash.com/photo-1618221823713-9806373b88b7?q=80&w=1000', permalink: '#' }, // Silk Dress Texture
        { id: '4', handle: '@klyora_official', img: 'https://images.unsplash.com/photo-1507473885765-e6ed05e53335?q=80&w=1000', permalink: '#' }, // Coffee/Lifestyle
        { id: '5', handle: '@klyora_official', img: 'https://images.unsplash.com/photo-1445205170230-053b83016050?q=80&w=1000', permalink: '#' }, // Fur Coat Texture
        { id: '6', handle: '@klyora_official', img: 'https://images.unsplash.com/photo-1490481651871-ab253a670147?q=80&w=1000', permalink: '#' } // Runway/Beige
    ];
    ...
    return (
        <section className="bg-white py-24 border-t border-black/5 overflow-hidden">
            <div className="text-center mb-12">
                <h2 className="text-[10px] uppercase tracking-[0.4em] font-bold text-black mb-2">The Atelier World</h2>
                <div className="flex items-center justify-center gap-2">
                    <p className="font-serif italic text-2xl text-zinc-500">@klyoraofficial</p>
                ...
                <div className="flex px-4 gap-4 md:gap-1.5 min-w-max mx-auto">
                    {posts.map(post => (
                        <a key={post.id} href={post.permalink} target="_blank" rel="noopener noreferrer" className="relative group w-[200px] md:w-[250px] aspect-square overflow-hidden cursor-pointer block">
                            <img src={post.img} alt={`Klyora style ${post.handle}`} loading="lazy" decoding="async" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
