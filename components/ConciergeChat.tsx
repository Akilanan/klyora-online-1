...
export const ConciergeChat: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <a href="mailto:support@klyoraofficial.com?subject=Concierge%20Inquiry" className="w-14 h-14 bg-black text-white rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-transform">
