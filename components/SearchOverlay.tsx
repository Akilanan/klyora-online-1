          ...
          <div className="p-8 md:p-12 flex flex-col gap-12 min-h-full">
            ...
            <div className="relative group">
              <input
                ...
                className={`w-full text-2xl md:text-3xl font-serif italic text-black bg-transparent outline-none placeholder:text-zinc-500 border-b pb-4 transition-all ${isAnalyzing ? 'border-black/50 opacity-50' : 'border-black/20 focus:border-black group-hover:border-black/40'}`}
              />
              ...
              <div className="absolute right-0 bottom-4 flex items-center gap-4">
                ...
                <button
                  ...
                  title="Visual Search"
                >
                  <svg className={`w-5 h-5 ${isAnalyzing ? 'animate-pulse text-black' : 'text-zinc-600 group-hover:text-black'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </button>
                <span className="text-zinc-600 text-[10px] uppercase tracking-widest pointer-events-none group-hover:text-black transition-colors">Search</span>
              </div>
            </div>
